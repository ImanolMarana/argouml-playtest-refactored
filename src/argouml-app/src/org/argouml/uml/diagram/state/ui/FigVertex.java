...
public class FigVertex extends FigNodeModelElement {
    ...
    private Object findRegion(Fig encloser, LayerPerspective lp) {
        ...
        if (encloser != null) {
            ...
            region = getRegionFromStateMachine(stateMachine);
        }
        return region;
    }

    private Object getRegionFromStateMachine(Object stateMachine) {
        Object region;
        List regions =
    ...
    private Object getRegionFromEncloser(Fig encloser) {
        ...
        if (regions.isEmpty()) {
            ...
            region = findRegionContainingVertex(encloser);
        }
        return region;
    }

    private Object findRegionContainingVertex(Fig encloser) {
        Object region = null;

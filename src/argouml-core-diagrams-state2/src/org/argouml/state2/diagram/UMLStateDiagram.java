...
public class UMLStateDiagram extends UMLDiagram implements StateDiagram {
    ...
    public DiagramElement createDiagramElement(
        ...
        if (Model.getFacade().isAFinalState(modelElement)) {
            ...
            return new FigVertex(modelElement, bounds, settings);
            ...
            return createPseudostate(modelElement, bounds, settings);
        }
        return null;
    }
    
    private DiagramElement createPseudostate(final Object modelElement,
        ...
        if (kind.equals(Model.getPseudostateKind().getInitial())) {
            return new FigInitialState(modelElement, bounds, settings);
                ...
                Model.getPseudostateKind().getEntryPoint())) {
            return new FigEntryPoint(modelElement, bounds, settings);
        } else if (kind.equals(
                Model.getPseudostateKind().getExitPoint())) {
            return new FigExitPoint(modelElement, bounds, settings);
        } else if (kind.equals(

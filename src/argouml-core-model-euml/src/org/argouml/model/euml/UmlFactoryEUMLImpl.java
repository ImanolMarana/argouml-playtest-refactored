...
//        {Message.class, ClassifierRole.class },
    ...
    public Object buildNode(Object elementType) {
        Object o = buildNodeForUseCase(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForClassifier(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForPackage(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForActivityGraph(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForAction(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForPin(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForState(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForPort(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForRegion(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForPseudostate(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForInstanceSpecification(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForClassifierRole(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForComponent(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForNode(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForComment(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForOperation(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForEnumeration(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForStereotype(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForProperty(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForSignal(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForException(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForTransition(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForParameter(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForExtensionPoint(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForReception(elementType);
        if (o != null) {
            return o;
        }
        o = buildNodeForSubsystem(elementType);
        if (o != null) {
            return o;
        }
    ...
    private Object buildNodeForUseCase(Object elementType) {
        if (elementType == metaTypes.getActor()) {
            ...
            return modelImpl.getExtensionMechanismsFactory().createTagDefinition();
    ...
    private Object buildNodeForClassifier(Object elementType) {
    ...
    private Object buildNodeForPackage(Object elementType) {
        if (elementType == metaTypes.getPackage()) {
            return modelImpl.getModelManagementFactory().createPackage();
        } else if (elementType == metaTypes.getProfile()) {
            return modelImpl.getModelManagementFactory().createProfile();
    ...
    private Object buildNodeForActivityGraph(Object elementType) {
        if (elementType == metaTypes.getActivity()) {
            return modelImpl.getActivityGraphsFactory().createActivityGraph();
    ...
    private Object buildNodeForAction(Object elementType) {
        if (elementType == metaTypes.getAcceptEventAction()) {
    ...
    private Object buildNodeForPin(Object elementType) {
        if (elementType == metaTypes.getInputPin()) {
    ...
    private Object buildNodeForState(Object elementType) {
        if (elementType == metaTypes.getState()) {
    ...
    private Object buildNodeForPort(Object elementType) {
        if (elementType == metaTypes.getPort()) {
            return UMLFactory.eINSTANCE.createPort();
        }
        return null;
    }

    private Object buildNodeForRegion(Object elementType) {
        if (elementType == metaTypes.getRegion()) {
            return UMLFactory.eINSTANCE.createRegion();
        }
        return null;
    }

    private Object buildNodeForPseudostate(Object elementType) {
        if (elementType == metaTypes.getPseudostate()) {
    ...
    private Object buildNodeForInstanceSpecification(Object elementType) {
        if (elementType == metaTypes.getInstanceSpecification()) {
    ...
    private Object buildNodeForClassifierRole(Object elementType) {
        if (elementType == metaTypes.getClassifierRole()) {
            return modelImpl.getCollaborationsFactory().createClassifierRole();
        } else if (elementType == metaTypes.getLifeline()) {
            return modelImpl.getCollaborationsFactory().createLifeline();
        }
        return null;
    }

    private Object buildNodeForComponent(Object elementType) {
        if (elementType == metaTypes.getComponent()) {
            return modelImpl.getCoreFactory().createComponent();
        }
        return null;
    }

    private Object buildNodeForNode(Object elementType) {
        if (elementType == metaTypes.getNode()) {
    ...
    private Object buildNodeForComment(Object elementType) {
        if (elementType == metaTypes.getComment()) {
    ...
    private Object buildNodeForOperation(Object elementType) {
        if (elementType == metaTypes.getOperation()) {
            return modelImpl.getCoreFactory().createOperation();
        }
        return null;
    }

    private Object buildNodeForEnumeration(Object elementType) {
        if (elementType == metaTypes.getEnumeration()) {
            return modelImpl.getCoreFactory().createEnumeration();
        } else if (elementType == metaTypes.getEnumerationLiteral()) {
            return modelImpl.getCoreFactory().createEnumerationLiteral();
        }
        return null;
    }

    private Object buildNodeForStereotype(Object elementType) {
        if (elementType == metaTypes.getStereotype()) {
            return modelImpl.getExtensionMechanismsFactory().createStereotype();
        }
        return null;
    }

    private Object buildNodeForProperty(Object elementType) {
        if (elementType == metaTypes.getAttribute()) {
            return modelImpl.getCoreFactory().createAttribute();
        }
        return null;
    }

    private Object buildNodeForSignal(Object elementType) {
        if (elementType == metaTypes.getSignal()) {
            return modelImpl.getCommonBehaviorFactory().createSignal();
        }
        return null;
    }

    private Object buildNodeForException(Object elementType) {
        if (elementType == metaTypes.getException()) {
            return modelImpl.getCommonBehaviorFactory().createException();
        }
        return null;
    }

    private Object buildNodeForTransition(Object elementType) {
    ...
    private Object buildNodeForParameter(Object elementType) {
        if (elementType == metaTypes.getParameter()) {
            return modelImpl.getCoreFactory().createParameter();
        }
        return null;
    }

    private Object buildNodeForExtensionPoint(Object elementType) {
        if (elementType == metaTypes.getExtensionPoint()) {
            return modelImpl.getUseCasesFactory().createExtensionPoint();
        }
        return null;
    }

    private Object buildNodeForReception(Object elementType) {
        if (elementType == metaTypes.getReception()) {
            return modelImpl.getCommonBehaviorFactory().createReception();
        }
        return null;
    }

    private Object buildNodeForSubsystem(Object elementType) {
        if (elementType == metaTypes.getProperty()) {
            return modelImpl.getCoreFactory().createAttribute();

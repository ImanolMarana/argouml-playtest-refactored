...
class XmiReaderEUMLImpl implements XmiReader {
    ...
    InputStream is = getInputStream(inputSource);
    String id = getFileIdentifier(inputSource);
  ...
  private InputStream getInputStream(InputSource inputSource) {
    InputStream is = inputSource.getByteStream();
    if (is == null && inputSource.getSystemId() != null) {
      is = getInputStreamFromSystemId(inputSource.getSystemId());
    }
    if (is == null) {
  ...
  private InputStream getInputStreamFromSystemId(String systemId) {
    InputStream is = null;
    try {
  ...
  private String getFileIdentifier(InputSource inputSource) {
  ...
  private void loadResource(Resource r, InputStream is) throws UmlException {

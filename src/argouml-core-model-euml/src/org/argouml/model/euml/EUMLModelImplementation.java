...
public class EUMLModelImplementation implements ModelImplementation {
    ...
    private void initializeEditingDomain() {
        ...
        List<AdapterFactory> factories = createAdapterFactoryList();
        ...
        if (path != null) {
            initializeExternalResource(path, resourceSet, extensionToFactoryMap, uriMap);
        }
      ...
      private List<AdapterFactory> createAdapterFactoryList() {
      ...
      private void initializeExternalResource(String path, ResourceSet resourceSet,
          Map<String, Object> extensionToFactoryMap, Map<URI, URI> uriMap) {
        try {
          ...
          //    path = '/' + path;
          //}
          URI uri = URI.createURI("jar:file:" //$NON-NLS-1$
              + path
              + "!/"); //$NON-NLS-1$
